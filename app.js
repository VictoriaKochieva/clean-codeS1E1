...
var incompleteTaskHolder=document.getElementById("tasks-incompleted");//ul of #tasks-incompleted
...
var createNewTaskElement=function(taskString){
    ...
    label.className='label tasks-content';

    //Each elements, needs appending
    checkBox.type="checkbox";
    editInput.type="text";
    editInput.className="input tasks-content task-input";
    ...
    deleteButtonImg.className="btn_delete-image";
